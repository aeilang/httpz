...
func TestCompressor(t *testing.T) {
	...
	r.Get("/gethtml", func(w http.ResponseWriter, r *http.Request) error {
	...
	r.Get("/getcss", func(w http.ResponseWriter, r *http.Request) error {
		w.Header().Set("Content-Type", "text/html")
		w.Write([]byte("textstring"))
		return nil
	})

	r.Get("/getplain", func(w http.ResponseWriter, r *http.Request) error {
		w.Header().Set("Content-Type", "text/html")
		w.Write([]byte("textstring"))
		return nil
	})
